...
/**
 * Write a description of class FlattenedSquareMatrix here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class FlattenedSquareMatrix implements SquareMatrixInterface{
    public FlattenedSquareMatrix(int[][] mat) {
